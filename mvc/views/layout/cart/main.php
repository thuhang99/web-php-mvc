            ...
            <div class="col-md-4">
                ...
                <div class="single-sidebar">
                    ...
                    <div class="thubmnail-recent">
                        <img src="assets/layout/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                            ...
                            <ul class="products">
                                <li class="product">
                                    <a href="single-product.html">
                                        <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="assets/layout/img/product-2.jpg">
                                ...
                                <li class="product">
                                    <a href="single-product.html">
                                        <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="assets/layout/img/product-4.jpg">
                                        <h3>Ship Your Idea</h3>
                                        <span class="price"><span class="amount">£20.00</span></span>
                                    </a>
