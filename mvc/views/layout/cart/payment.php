                                ...
                                <div class="col-1">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                            <label class="" for="name">Họ tên <abbr title="required" class="required">*</abbr>
                                            </label>
                                        ...
                                        <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                            <label for="province">Tỉnh / Thành phố <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <select class="country_to_state country_select" id="province" name="province" onchange="area('dictrict', 0, 'province')">
                                                <?php echo $data['provine']; ?>
                                            </select>
                                        </p>

                                        <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                            <label class="" for="dictrict">Quận / Huyện <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <select class="country_to_state country_select" id="dictrict" name="dictrict" onchange="area('wards', 0, 'dictrict')">
                                            </select>
                                        </p>

                                        <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                            <label class="" for="wards">Phường / Xã <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <select class="country_to_state country_select" id="wards" name="wards">
                                            </select>
                                        </p>

                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            <label class="" for="address">Địa chỉ <abbr title="required" class="required">*</abbr>
                                            </label>
                                ...
                                <div class="col-2">
                                    <div class="woocommerce-shipping-fields">
                                        <h3 id="ship-to-different-address">
                                            <label class="checkbox" for="ship-to-different-address-checkbox">Phương thức giao hàng</label>
                                        </h3>
                                        <div>
                                            <ul>
                                                <li>
                                ...
                                <table class="shop_table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($_SESSION['cart'] as $key => $value){ 
                                            ...
                                            //$congtienhang = $congtienhang + ($value['qty']*$value['price']);
                                        ?>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-total">
                                                <span class="amount">
                                                    <?php echo number_format($value['qty']*$value['price']); ?> VNĐ
                                                </span>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><span class="amount">
                                                <?php echo number_format($congtienhang); ?> VNĐ
                                            </span>
                                            </td>
                                        </tr>
